...
class FAEL_Post_Excerpt extends FAEL_Widget_Base {
    ...
    public function get_title() {
        return __( 'UF Post EXCERPT', 'fael' );
    }
    ...
    /**
     * Register FAEL_Post_Excerpt widget controls.
     *
    ...
    /**
     * Render FAEL_Post_Excerpt widget output on the frontend.
     *
    ...
    protected function render() {
        ...
        FAEL_Form_Elements()->set_form_element( $s['form_handle'], 'post_excerpt', apply_filters( 'fael_form_field', array(
            'rules' => array(
        ...
        FAEL_Form_Elements()->populate_field( $s['form_handle'], 'post_excerpt', $s['value'] );
        ...
        <!--<div id="<?php /*echo $s['element_id']; */?>" class="position-relative form-group <?php /*echo $s['element_class']; */?>">
            <label for="<?php /*echo $s['form_handle']; */?>[<?php /*echo 'post_excerpt'; */?>]" class=""><?php /*echo $s['label']; */?></label>
            <textarea name="<?php /*echo $s['form_handle']; */?>[<?php /*echo 'post_excerpt'; */?>]['value']"
                      placeholder="<?php /*echo $s['placeholder']; */?>"
                      class="form-control"

                      v-model="fael_forms['<?php /*echo $s['form_handle']; */?>']['<?php /*echo 'post_excerpt'; */?>'].value"
            >
                <?php /*echo $fael_forms[$s['form_handle']]['post_excerpt']['value']; */?>
            </textarea>
            <div>
        ...
        <div id="<?php echo $s['element_id']; ?>" class="position-relative form-group <?php echo $s['element_class']; ?>">
            <label for="<?php echo $s['form_handle']; ?>[<?php echo 'post_excerpt'; ?>]" class="">
                <?php echo $s['label']; ?>
                <?php echo $s['is_required'] == 'yes' ? '<span style="color: red;">&ast;</span>' : ''; ?>
            </label>
            <?php
            wp_editor( $fael_forms[$s['form_handle']]['post_excerpt']['value'], $s['form_handle'].'-'.'post_excerpt', array(
